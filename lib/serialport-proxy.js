...
const log = {
  info: Debug('zigbee2mqtt-adapter-proxy:serialportproxy'),
  error: Debug('zigbee2mqtt-adapter-proxy:serialportproxy:error'),
  debug: Debug('zigbee2mqtt-adapter-proxy:serialportproxy:debug'),
  data: Debug('zigbee2mqtt-adapter-proxy:serialportproxy:data'),
}
